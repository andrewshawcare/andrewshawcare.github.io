...
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);

class Callout extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    constructor({ type } = { type: "note" }) {
        super();
        this.type = type;
    }
    render() {
        return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `<p class="${this.type}"><slot></slot></p>`;
    }
}
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _callout_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);

customElements.define("callout", _callout_index_js__WEBPACK_IMPORTED_MODULE_0__.Callout);
